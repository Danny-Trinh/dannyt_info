...
class Pokemon(models.Model):
    ...
    gender = models.CharField(choices=GENDER, max_length=1, default='M', editable=False)
    ...
    b_s_defense = models.IntegerField('base special defense', default=0, editable=False)
    b_s_attack = models.IntegerField('base special attack', default=0, editable=False)
    ...
    s_defense = models.IntegerField('special defense', default=0, editable=False)
